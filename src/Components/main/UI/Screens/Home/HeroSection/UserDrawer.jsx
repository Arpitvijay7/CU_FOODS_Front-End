      ...
      <div className="drawer-side z-10">
        ...
        <ul className="menu w-80 p-4 min-h-full bg-base-200 text-base-content flex flex-col justify-between">
          <div>
            ...
            <div className="bg-base-200 text-lg font-semibold rounded-box mt-5">
              <div className="bg-white rounded-2xl p-2 pt-3">
              ...
              <div className="bg-white rounded-2xl p-2 pt-3 mt-3">
                <div className="pb-2 flex justify-start items-center gap-x-2">
                  <div className="w-1 h-8 rounded-full bg-[crimson]" />
                  Customer
                </div>
              ...
              <div className="bg-white rounded-2xl p-2 pt-3 mt-3 mb-5">
                <div className="pb-2 flex justify-start items-center gap-x-2">
                  <div className="w-1 h-8 rounded-full bg-[crimson]" />
                  Vendor
                </div>
