...
const TermsAndConditions = () => {
  ...
  return (
    <div className="min-h-screen py-8 pt-2">
      <button onClick={() => navigate(-1)} className="md:hidden pl-5">
        <svg
      ...
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold mb-4 text-center md:text-left">Terms & Conditions</h1>
        ...
        <p className="text-gray-700 mb-4">
          ...
          Arpit Vijay's relationship with you in relation to this website.
        </p>

        <p className="text-gray-700">
          The term 'Arpit Vijay' or 'us' or 'we' refers to the owner of the
          website whose registered/operational office is Chandigarh University
          Kharar, Punjab, 140301 Mohali PUNJAB 140301. The term 'you' refers to
        ...
        <ul className="list-disc pl-6 mb-4 text-gray-700">
          ...
          <li>
            ...
            document without Arpit Vijay's prior written consent.
          </li>
          <li>
