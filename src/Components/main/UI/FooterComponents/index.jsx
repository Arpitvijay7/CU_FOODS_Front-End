    ...
    <>
      <footer className="text-gray-600 hidden lg:block">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <Link
            to="/"
            className="flex-shrink-0 md:mx-0 md:mt-[-45px] mb-[-30px] mx-auto text-center md:text-left"
          >
            <p className="flex  font-medium items-center md:justify-start justify-center text-gray-900">
              <img className="w-[192px]" src={logo} alt="Cufoodz Logo" />
            </p>
          </Link>
